...
class StudentStudyMaterialScreen extends GetView<StudentStudyMaterialController> {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: isSelected
                      ? null
                      : Border.all(color: AppColors.borderGrey.withOpacity(0.5)),
                ),
  ...
  Widget _buildMaterialCard(Map<String, dynamic> item) {
    return GestureDetector(
      onTap: () => Get.toNamed('/student/study-material/detail', arguments: item),
      child: Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(
                item['isVideo'] ? Icons.play_circle_outline_rounded : Icons.insert_drive_file_outlined,
                size: 14,
                color: AppColors.textTertiary,
              ),
